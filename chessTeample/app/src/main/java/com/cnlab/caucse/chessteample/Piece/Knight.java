...
public class Knight extends Piece {
    ...
    public ArrayList<Position> getCanMoves(Tile[][] btnex) {
        ...
        if(pos1.isValid()){ // 이동위치가 말판 안에 있는가?
            if(!btnex[pos1.getX()][pos1.getY()].getColor().equals(this.color) && !btnex[pos1.getX()][pos1.getY()].getColor().equals(teamcolor)){ // 같은색이면 이동못해, 다른색이면 이동가능!
                canmove.add(pos1);
            }
        }
        ...
        if(pos2.isValid()){ // 이동위치가 말판 안에 있는가?
            if(!btnex[pos2.getX()][pos2.getY()].getColor().equals(this.color) && !btnex[pos2.getX()][pos2.getY()].getColor().equals(teamcolor)){ // 같은색이면 이동못해, 다른색이면 이동가능!
                canmove.add(pos2);
            }
        }
        ...
        if(pos3.isValid()){ // 이동위치가 말판 안에 있는가?
            if(!btnex[pos3.getX()][pos3.getY()].getColor().equals(this.color) && !btnex[pos3.getX()][pos3.getY()].getColor().equals(teamcolor)){ // 같은색이면 이동못해, 다른색이면 이동가능!
                canmove.add(pos3);
            }
        }
        ...
        if(pos4.isValid()){ // 이동위치가 말판 안에 있는가?
            if(!btnex[pos4.getX()][pos4.getY()].getColor().equals(this.color) && !btnex[pos4.getX()][pos4.getY()].getColor().equals(teamcolor)){ // 같은색이면 이동못해, 다른색이면 이동가능!
                canmove.add(pos4);
            }
        }
        ...
        if(pos5.isValid()){ // 이동위치가 말판 안에 있는가?
            if(!btnex[pos5.getX()][pos5.getY()].getColor().equals(this.color) && !btnex[pos5.getX()][pos5.getY()].getColor().equals(teamcolor)){ // 같은색이면 이동못해, 다른색이면 이동가능!
                canmove.add(pos5);
            }
        }
        ...
        if(pos6.isValid()){ // 이동위치가 말판 안에 있는가?
            if(!btnex[pos6.getX()][pos6.getY()].getColor().equals(this.color) && !btnex[pos6.getX()][pos6.getY()].getColor().equals(teamcolor)){ // 같은색이면 이동못해, 다른색이면 이동가능!
                canmove.add(pos6);
            }
        }
        ...
        if(pos7.isValid()){ // 이동위치가 말판 안에 있는가?
            if(!btnex[pos7.getX()][pos7.getY()].getColor().equals(this.color) && !btnex[pos7.getX()][pos7.getY()].getColor().equals(teamcolor)){ // 같은색이면 이동못해, 다른색이면 이동가능!
                canmove.add(pos7);
            }
        }
        ...
        if(pos8.isValid()){ // 이동위치가 말판 안에 있는가?
            if(!btnex[pos8.getX()][pos8.getY()].getColor().equals(this.color) && !btnex[pos8.getX()][pos8.getY()].getColor().equals(teamcolor)){ // 같은색이면 이동못해, 다른색이면 이동가능!
                canmove.add(pos8);
            }
        }
        return canmove;
