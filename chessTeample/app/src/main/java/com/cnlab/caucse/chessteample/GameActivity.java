...
//        tv.setText(stringFromJNI());
    ...
    public boolean checkcheckmate(){
        ...
        for(int i = 0; i <=13; i ++){
            for(int j = 0; j <=13; j++){
                if(btnEx[i][j].isOnPiece()==true){
                    for(int z = 0; z<btnEx[i][j].getPiece().getCanMoves(btnEx).size(); z++){
                        if(btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].getPiecetype().equals("KING")){
                           checkcolor = btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].getColor();
                        }
                    }
                }
            }
        ...
        for(int i = 0; i <=13; i ++){
            for(int j = 0; j <=13; j++){
                if(btnEx[i][j].isOnPiece()==true && btnEx[i][j].getColor().equals(mycolor)){
                    if(checkcolor.equals(mycolor)){
                        String temp = "";
                        for(int z = 0; z<btnEx[i][j].getPiece().getCanMoves(btnEx).size(); z++){
                         temp =btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].getColor();
                                ...
                                for(int b = 0; b <=13; b++){
                                    if(btnEx[a][b].isOnPiece()==true){
                                        for(int c = 0; c<btnEx[a][b].getPiece().getCanMoves(btnEx).size(); c++){
                                            if(!(btnEx[btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getX()][btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getY()].getPiecetype().equals("KING") && btnEx[btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getX()][btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getY()].getColor().equals(mycolor))){
                                                btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].setOnPiece(true);
                                                btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].setColor(mycolor);
                 ...
                 /*   else if(checkcolor.equals(teamcolor)){
                                ...
                                for(int b = 0; b <=13; b++){
                                    if(btnEx[a][b].isOnPiece()==true){
                                        for(int c = 0; c<btnEx[i][j].getPiece().getCanMoves(btnEx).size(); c++){
                                            if(!(btnEx[btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getX()][btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getY()].getPiecetype().equals("KING") && btnEx[btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getX()][btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getY()].getColor().equals(teamcolor))){
                                                btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].setOnPiece(true);
                                                btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].setColor(mycolor);
                                                btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].setColor(temp);
                                                if(!temp.equals("NONE")){
                    ...
                    else if(!checkcolor.equals("NONE")){
                        for(int z = 0; z<btnEx[i][j].getPiece().getCanMoves(btnEx).size(); z++){
                            String temp =btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].getColor();
                            btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].setOnPiece(false);
                            btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].setColor(mycolor);
                            ...
                            for(int a = 0; a <=13; a ++){
                                for(int b = 0; b <=13; b++){
                                    if(btnEx[a][b].isOnPiece()==true){
                                        for(int c = 0; c<btnEx[a][b].getPiece().getCanMoves(btnEx).size(); c++){
                                            if((btnEx[btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getX()][btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getY()].getPiecetype().equals("KING") && btnEx[btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getX()][btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getY()].getColor().equals(checkcolor))){
                                                btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].setOnPiece(true);
                                                btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].setColor(mycolor);
                                                btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(z).getY()].setColor(temp);
                                                if(!temp.equals("NONE")){
                ...
                for (int b = 0; b < 14; b++) {
                    if(btnEx[a][b].getColor().equals(mycolor) && myturn == true){
                        for(int c =0 ; c<btnEx[a][b].getPiece().getCanMoves(btnEx).size();c++){
                            ...
                            btnEx[a][b].setOnPiece(false);
                            btnEx[a][b].setColor("NONE");

                            for(int i =0; i<14 ; i++){
                                for(int j = 0 ; j<14; j++){
                                    for(int k = 0 ; k<btnEx[i][j].getPiece().getCanMoves(btnEx).size();k++){
                                        if(!(btnEx[btnEx[i][j].getPiece().getCanMoves(btnEx).get(k).getX()][btnEx[i][j].getPiece().getCanMoves(btnEx).get(k).getY()].getPiecetype().equals("KING"))){

                                            btnEx[btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getX()][btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getY()].setColor(temp);
                                            if(temp.equals("NONE")){
                                                btnEx[btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getX()][btnEx[a][b].getPiece().getCanMoves(btnEx).get(c).getY()].setOnPiece(false);
                                            }
                                            btnEx[a][b].setOnPiece(true);
                                            btnEx[a][b].setColor(mycolor);
                                            return false;
                                        }
                                    }
                                }
    ...
    if(mycolor.equals("WHITE")){
        ...
        if(mycolor.equals("GREEN")){
            ...
            btn[6][0].setImageResource(R.mipmap.queen_red);
            btnEx[6][0] = new Tile("QUEEN", "RED", new Position(6,0));
            btn[7][0].setImageResource(R.mipmap.king_red);
            btnEx[7][0] = new Tile("KING", "RED", new Position(7,0));
        ...
        if(mycolor.equals("RED")){
            ...
            btn[6][0].setImageResource(R.mipmap.queen_green);
            btnEx[6][0] = new Tile("QUEEN", "GREEN", new Position(6,0));
            btn[7][0].setImageResource(R.mipmap.king_green);
            btnEx[7][0] = new Tile("KING", "GREEN", new Position(7,0));
            ...
            btn[6][13].setImageResource(R.mipmap.king_red);
            btnEx[6][13] = new Tile("KING", "RED", new Position(6,13));
            btn[7][13].setImageResource(R.mipmap.queen_red);
            btnEx[7][13] = new Tile("QUEEN", "RED", new Position(7,13));
